...
\begin{itemize}
    ...
    \item $r_4$ ed $r_5$ hanno precedenza su $r_2$ ed $r_3$
    \item La popolazione \textit{hat} conosce le scorciatoie, \textit{check} no
\end{itemize}

\vspace{0.25cm}

\begin{center}
    \textbf{Non descrivibile con il modello presentato}
\end{center}
