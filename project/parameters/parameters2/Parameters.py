...
class Parameters:
    ...
    def tau_hat(self, eta_hat, eta_check):
        ...
        return SafeArray([5/2+eta_hat_t[0], 1, np.inf, np.inf, (eta_hat_t[4]+eta_check_t[4])/(1-(eta_hat_t[4]+eta_check_t[4])), np.inf, 1]) + self.variation_hat
    ...
    def tau_check(self, eta_hat, eta_check):
        ...
        eta_hat_t = eta_hat.flatten()
        eta_check_t = eta_check.flatten()
        return SafeArray([np.inf, np.inf, 1, 2+eta_check_t[3], (eta_hat_t[4]+eta_check_t[4])/(1-(eta_hat_t[4]+eta_check_t[4])), 1, np.inf]) + self.variation_check