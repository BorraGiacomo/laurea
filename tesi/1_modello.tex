...
$\widecheck{\mathcal{N}}$, costituita dai percorsi $\widecheck{\gamma}_1,...,\widecheck{\gamma}_{\widecheck{n}}$. Queste due sottoreti
devono essere grafi orientati aciclici (DAG) e, ovviamente, connessi. Si noti che non è necessario imporre queste condizioni
...
Supponiamo che il numero totale di veicoli della popolazione per ognuna delle popolazioni presenti sulla rete sia 1. Chiamiamo $\widehat{\theta_i}$ il numero
...
è un punto del simplesso $S^{\widehat{n}}$ di dimensione $\widehat{n}$; rispettivamente $\widecheck{\theta}\equiv(\widecheck{\theta}_1,...,\widecheck{\theta}_{\widecheck{n}})$
è un punto del simplesso $S^{\widecheck{n}}$ di dimensione $\widecheck{n}$. $\widehat{\theta}$ e $\widecheck{\theta}$ sono identificabili
