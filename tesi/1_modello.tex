...
Notiamo che l'Equazione \ref{eq:1} e l'Equazione \ref{eq:1} non cambiano anche nel caso in cui si utilizzino le funzioni di costo 
come nell'Equazione \ref{eq:10}.
...
Notiamo che l'analisi effettuata in questa sezione non cambia se si utilizzano le funzioni di costo come nell'Equazione \ref{eq:10}.
