...
attraversamento della rete rispetto alla variazione dei costi delle strade definita in \textbf{param}, Listato~\ref{script:1}. Decide se costruire tale grafico e presentarlo all'utente
...
definiti in \textbf{Initializer}, vedi Lisato~\ref{script:4}. È utile introdurre anche un coefficiente di variazione, utile per il calcolo effettuato nel Listato~\ref{script:6}, che verrà applicato ai costi delle strade
