...
possono rappresentare criteri distinti per le due popolazioni. Per esempio...

Da un punto di vista modellistico è naturale assumere che:
\begin{equation*} 
    \begin{split}
    \forall \widehat{\eta}, \widecheck{\eta}', \widecheck{\eta}''\in[0,1]\:!!!!piùspazio\widecheck{\eta}'\leq\widecheck{\eta}''\implies\widehat{\tau}(\widehat{\eta}, \widecheck{\eta}')\leq\widehat{\tau}(\widehat{\eta}, \widecheck{\eta}''),\,\widecheck{\tau}(\widehat{\eta}, \widecheck{\eta}')\leq\widecheck{\tau}(\widehat{\eta}, \widecheck{\eta}'')\\
