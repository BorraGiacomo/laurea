...
rispettivamente i costi della strada $r_h$, $h\in\{1,...,N\}$, per la popolazione \textit{hat} e per la popolazione \textit{check}. In questa trattazione considereremo i costi come tempi di viaggio,
in quanto ciò permette di aggiungere $+\infty$ ai valori che le funzioni di costo possono assumere, rappresentante una strada
completamente congestionata o, comunque, bloccata/non percorribile (vedi \cite[cap. 2]{MR4911797}).
