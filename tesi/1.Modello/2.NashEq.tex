...
\begin{definition}\label{def:4}
    È detto \textit{tempo di attraversamento della rete}, distintamente per le due popolazioni (e quindi per le due reti $\widehat{\mathcal{N}}$ e $\widecheck{\mathcal{N}}$), il valore comune assunto dai $T$ rilevanti (\autoref{def:1})
...
maggiori del tempo medio di attraversamento della rete, di conseguenza:
\begin{equation*}
    \begin{split}
