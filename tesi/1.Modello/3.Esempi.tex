...
\includegraphics[height=8cm]{../figures/Es1/grafico_main_Variazione_del_costo_delle_strade.png}

\begin{tabular}{cc}

\includegraphics[height=5.5cm]{../figures/Es1/grafico_hat/hat_theta_1_Variazione_del_costo_delle_strade.png} &
\includegraphics[height=5.5cm]{../figures/Es1/grafico_check/check_theta_1_Variazione_del_costo_delle_strade.png} \\

\includegraphics[height=5.5cm]{../figures/Es1/grafico_hat/hat_theta_2_Variazione_del_costo_delle_strade.png} &
\includegraphics[height=5.5cm]{../figures/Es1/grafico_check/check_theta_2_Variazione_del_costo_delle_strade.png} \\

\includegraphics[height=5.5cm]{../figures/Es1/grafico_hat/hat_theta_3_Variazione_del_costo_delle_strade.png} &
\includegraphics[height=5.5cm]{../figures/Es1/grafico_check/check_theta_3_Variazione_del_costo_delle_strade.png} \\

\end{tabular}

\end{center}
\end{figure}
Con l'aumentare del costo di $r_5$ si ottiene un risultato inatteso: il tempo di attraversamento della rete diminuisce. Progressivamente
...
Spingendoci oltre, notiamo che questa situazione paradossale è molto fragile; infatti se esaminiamo il caso in cui $\widehat{\tau_5}(\eta) = \widecheck{\tau_5}(\eta) = 0$ e facciamo variare 
...
\includegraphics[height=8cm]{../figures/Es1/grafico_main_Variazione_del_numero_di_individui_nella_popolazione.png}

\begin{tabular}{cc}

\includegraphics[height=5.5cm]{../figures/Es1/grafico_hat/hat_theta_1_Variazione_del_numero_di_individui_nella_popolazione.png} &
\includegraphics[height=5.5cm]{../figures/Es1/grafico_check/check_theta_1_Variazione_del_numero_di_individui_nella_popolazione.png} \\

\includegraphics[height=5.5cm]{../figures/Es1/grafico_hat/hat_theta_2_Variazione_del_numero_di_individui_nella_popolazione.png} &
\includegraphics[height=5.5cm]{../figures/Es1/grafico_check/check_theta_2_Variazione_del_numero_di_individui_nella_popolazione.png} \\

\includegraphics[height=5.5cm]{../figures/Es1/grafico_hat/hat_theta_3_Variazione_del_numero_di_individui_nella_popolazione.png} &
\includegraphics[height=5.5cm]{../figures/Es1/grafico_check/check_theta_3_Variazione_del_numero_di_individui_nella_popolazione.png} \\

\end{tabular}

\end{figure}
Aumentando il numero di veicoli delle due popolazioni si ottiene, a seguito di una breve crescita del tempo di attraversamento, una fase transitoria
...
Introduciamo ora una rete particolare, in cui l'aggiunta di una strada utilizzata solo da una popolazione peggiora solo il tempo di attraversamento dell'altra:
\[
\quad
\begin{tikzpicture}[scale=1.2]
...
\includegraphics[height=8cm]{../figures/Es2/grafico_main_Variazione_del_costo_delle_strade.png}

\begin{tabular}{cc}

\includegraphics[height=5.5cm]{../figures/Es2/grafico_hat/hat_theta_1_Variazione_del_costo_delle_strade.png} &
\includegraphics[height=5.5cm]{../figures/Es2/grafico_check/check_theta_1_Variazione_del_costo_delle_strade.png} \\

\includegraphics[height=5.5cm]{../figures/Es2/grafico_hat/hat_theta_2_Variazione_del_costo_delle_strade.png} &
\includegraphics[height=5.5cm]{../figures/Es2/grafico_check/check_theta_2_Variazione_del_costo_delle_strade.png} \\

\includegraphics[height=5.5cm]{../figures/Es2/grafico_hat/hat_theta_3_Variazione_del_costo_delle_strade.png} &
\rule{0pt}{5.5cm} \\
...
Nuovamente si nota che questo stato paradossale è fragile: facendo variare, per esempio, il numero di veicoli nella popolazione \textit{check}, da $\widecheck{\zeta} = 1$
...
\includegraphics[height=8cm]{../figures/Es2/grafico_main_Variazione_del_numero_di_individui_nella_popolazione.png}

\begin{tabular}{cc}

\includegraphics[height=5.5cm]{../figures/Es2/grafico_hat/hat_theta_1_Variazione_del_numero_di_individui_nella_popolazione.png} &
\includegraphics[height=5.5cm]{../figures/Es2/grafico_check/check_theta_1_Variazione_del_numero_di_individui_nella_popolazione.png} \\

\includegraphics[height=5.5cm]{../figures/Es2/grafico_hat/hat_theta_2_Variazione_del_numero_di_individui_nella_popolazione.png} &
\includegraphics[height=5.5cm]{../figures/Es2/grafico_check/check_theta_2_Variazione_del_numero_di_individui_nella_popolazione.png} \\

\includegraphics[height=5.5cm]{../figures/Es2/grafico_hat/hat_theta_3_Variazione_del_numero_di_individui_nella_popolazione.png} &
\rule{0pt}{5.5cm} \\
