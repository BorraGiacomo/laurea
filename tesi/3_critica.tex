...
Facendo ciò si otterrà un peggioramento nel tempo di viaggio per la popolazione \textit{check}
...
\includegraphics[height=6cm]{../figures/Es3/grafico_main_check_Variazione_del_costo_delle_strade.png}\\
\end{tabular}
\caption*{Tempo di viaggio al variare del costo delle scorciatoie, utilizzando le funzioni di costo definite in \autoref{eq:13}.}
\end{figure}
...
\end{tabular}
\caption*{Tempo di viaggio al variare del costo delle scorciatoie, utilizzando le funzioni di costo definite in \autoref{eq:14}.}
\end{figure}
